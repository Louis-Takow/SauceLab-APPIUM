...
describe('My register application - Negative, and Postive cases', () => {
    it('should trigger an error for mismatching passwords - Negative Case', async () => {
        ...
        // set a mismatching value to Confirm the password field
